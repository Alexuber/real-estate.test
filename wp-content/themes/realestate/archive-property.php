                ...
                <div class="col-md-9  pr0 padding-top-40 properties-page">
                    ...
                    <div class="col-md-12 clear"> 
                        ...
                        while ( have_posts() ) :
                            ...
                            // создаем переменную $price для кастомного поля price 
                            $price = get_post_meta(get_the_ID(), 'price',true);

                            // создаем переменную $area для кастомного поля area
                            ...
                            <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            <h5><a href="<?php  echo get_the_post_thumbnail_url(); ?>"> <?php the_title(); ?> </a></h5>
                                            <div class="dot-hr"></div>
                                            <!-- перевіряємо чи є данні в кастомних полях прайс і ареа -->
                                            <?php if(!empty($area)) { ?>
                                            <!-- виводимо кастомны поля 'area'-->
